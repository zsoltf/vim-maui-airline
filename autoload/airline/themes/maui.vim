...
function! airline#themes#maui#refresh()
  ...
  let s:N1 = airline#themes#get_highlight2(['Statement', 'fg'], ['Function', 'bg'])
  let s:N2 = airline#themes#get_highlight2(['Function', 'fg'], ['Statement', 'bg'])
  ...
  let s:I2 = airline#themes#get_highlight2(['Statement', 'fg'], ['DbgCurrent', 'bg'])
  let s:I3 = s:N3
  ...
  let s:R1 = airline#themes#get_highlight2(['DbgCurrent', 'bg'], ['ErrorMsg', 'fg'], 'bold')
  let s:R2 = airline#themes#get_highlight2(['ErrorMsg', 'fg'], ['DbgCurrent', 'bg'])
  let s:R3 = s:N3
  ...
  let s:V1 = airline#themes#get_highlight2(['DbgCurrent', 'bg'], ['Function', 'fg'], 'bold')
  let s:V2 = airline#themes#get_highlight2(['Function', 'fg'], ['DbgCurrent', 'bg'])
  let s:V3 = s:N3
  ...
  let s:IA = airline#themes#get_highlight2(['DbgCurrent', 'fg'], ['CursorLine', 'bg'], 'bold')
  ...
  let g:airline#themes#maui#palette.inactive_modified = {
        \ 'airline_c': s:Nmod
        \ }
  let g:airline#themes#maui#palette.tabline = {
        \ 'airline_tabmod':  ['#870000', '#ff8700',  88, 208, 'bold'],
        \ }
endfunction
